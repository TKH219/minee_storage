...
void main() {
  ...
  testWidgets('shows a theme row and a language row', (tester) async {
  ...
  testWidgets('the language row matches the theme row geometry', (tester) async {
    await pumpLocalizedApp(tester, host());
    ...
    expect(sizes[0].height, SettingsMetrics.tileMinHeight);
    expect(sizes[1].height, SettingsMetrics.tileMinHeight);
